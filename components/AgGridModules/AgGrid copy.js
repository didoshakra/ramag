...
export default function AgGrid({
  ...
  const profile = 0
  let { isAdd, isEdit, isDelete, isImportExell, isExportExell, isPrint } = false //
  ...
  const onGridReady = (params) => {
    console.log("AgGrid.js/onGridReady")
    // alert("onGridReady")
    ...
    <div style={{ height: "100%", width: "100%" }}>
      ...
      >
        <AgGridReact
          ...
          //   onFilterOpened={() => document.querySelector("#filterTextBox")?.focus()}
          frameworkComponents={frameworkComponents} //Для checkBox // suppressCellFocus={true}//Блокує навігацію
          клавішами // onCellClicked={onCellClicked} // // onRowEditingStarted={onRowEditingStarted}
          // onRowEditingStopped={onRowEditingStopped}
          // onCellEditingStarted={onCellEditingStarted}
          // onCellEditingSt/opped={onCellEditingStopped}
          // RowClicked={onRowClicked}
          // alwaysShowHorizontalScroll={true}//Полоса прокрутки завжди // alwaysShowVerticalScroll={true}//Полоса
          прокрутки
          завжди
