...
export default function handler(req, resp) {
  ...
  const sql = "insert into d_client(name,last_name,email,skod,discont_proc) VALUES($1,$2,$3,$4,$5) RETURNING *"
  const sqlvalues = [data.name, data.last_name, data.email, data.skod, data.discont_proc]
