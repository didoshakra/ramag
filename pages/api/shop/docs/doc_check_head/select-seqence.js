...
//Отримати код для №чека(doc_check_products.check_id= doc_check_head.id)
//iз послідовності// SELECT nextval('doc_check_head_id_seq')
...
export default function handler(req, resp) {
  ...
  const sql = `SELECT nextval('doc_check_head_id_seq')`
