...
function Department({ data, isDovidnuk = false, setDovActive, setValue }) {
  ...
  return (
    <div style={{ height: "100%", width: "100%" }}>
      ...
      {formActive && <DepartmentForm onCloseForm={onCloseForm} formData={formData} />}
      {/* --- */}
      <style jsx>{`
...
export async function getServerSideProps(context) {
  ...
  //   const response = await fetch("http://localhost:3000/api/shop/references/d_department/select-all")
