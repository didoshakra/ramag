...
function Category({ data, isDovidnuk = false, setDovActive, setValue }) {
  ...
  //------------------------------------------------------------------------------------------------------------ */
  const refreshState = () => {
    // console.log("Category.js/refreshState")
    setRowData(data) //з сервера Pg
  }
  ...
  const toDov = () => {
    // console.log("Category.js/toDov/SelectedRowState=", selectedRowState["0"])
    setDovActive("")
  ...
  return (
    <div style={{ height: "100%", width: "100%" }}>
      ...
      {formActive && <CategoryForm onCloseForm={onCloseForm} formData={formData} />}
      {/* --- */}
      <style jsx>{`
