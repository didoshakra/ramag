//doc_check_products.js //Основа- Довідник/НеДовідник\getServerSideProps(context)/useSWR/agGrid\...Form
    ...
    return (
      <div className="headItemWrapper">
        ...
        <div className="headItem">
          ...
          {/* <p className="sum2">{docHeadData.discont}</p> */}
          <p className="sum2">
            {/* {Number(docHeadData.total)} */}
            {Number(docHeadData.total) * (Number(docHeadData.discont_proc) / 100).toFixed(2)}
          </p>
        </div>
        <div className="headItem">
          ...
          <p className="sum1">
            {/* {Number(docHeadData.total)} */}
            {(Number(docHeadData.total) * (1 - Number(docHeadData.discont_proc) / 100)).toFixed(2)}
          </p>
        </div>
        <style jsx>{`
          .headItemWrapper {
          ...
          .label1 {
            ...
            font-weight: 500;
            font-size: 30px;
            // color: ${theme.colors.docHeadLable};
    ...
    <div style={{ height: "100%", width: "100%" }}>
      ...
      {isPaymentDialog && (
        <PaymentDialog
          ...
          total={(Number(docHeadData.total) * (1 - Number(docHeadData.discont_proc) / 100)).toFixed(2)}
        />
      )}
      {isClientDialog && (
